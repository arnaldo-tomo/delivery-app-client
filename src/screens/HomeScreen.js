...
export default function HomeScreen({ navigation }) {
  ...
  async function loadData() {
    try {
      ...
      // console.log(restaurantsResponse.data.data.data);
      setRestaurants(restaurantsResponse.data.data.data);
      ...
      >
        ...
        <View style={styles.restaurantInfo}>
          ...
          <View style={styles.restaurantMeta}>
            ...
            <Text style={styles.deliveryFee}>Taxa: R$ 5,00</Text>
          </View>
        </View>
      </TouchableOpacity>
    );
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.banner}>
        <View style={styles.bannerContent}>
          ...
          <Text style={styles.bannerSubtitle}>Em pedidos acima de R$ 30,00</Text>
        </View>
